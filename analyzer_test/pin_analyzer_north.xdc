...
set_property PACKAGE_PIN T5  [get_ports analyzer_d[7]]
set_property PACKAGE_PIN U5  [get_ports analyzer_d[6]]

# LVDS_2 [JX1_23] (non inverted)
set_property PACKAGE_PIN P15 [get_ports {analyzer_d[5]}]
set_property PACKAGE_PIN P16 [get_ports {analyzer_d[4]}]
...
# LVDS_5A [BANK13_00_P]
set_property PACKAGE_PIN U7 [get_ports {analyzer_d[8]}]

# LVDS_5B [BANK13_00_N]
set_property PACKAGE_PIN V7 [get_ports {analyzer_d[9]}]

# LVDS_4A [BANK13_02_N]
set_property PACKAGE_PIN W8 [get_ports {analyzer_d[10]}]

# LVDS_4B [BANK13_02_P]
set_property PACKAGE_PIN V8 [get_ports {analyzer_d[11]}]
